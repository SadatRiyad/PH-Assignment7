        ...
        <div>
            ...
            <header>
                <div className="container text-center mx-auto p-4">
                    ...
                    <p className="text-white mb-5 opacity-70 mb-5 mt-7 text-sm px-4">Welcome to BB-Food, where culinary exploration knows no bounds! <br />Our mission is to transcend borders and bring people together through the universal language of food.
                    </p>
