        ...
        <div>
            ...
            <header>
                <div className="container text-center mx-auto p-4">
                    ...
                    <a href="#recipes"><button className="btn bg-green hover:bg-transparent border-green text-primary hover:text-white mt-12 m-4 rounded-full hover:-translate-y-1 transition-all duration-200">Explore Now</button></a>
