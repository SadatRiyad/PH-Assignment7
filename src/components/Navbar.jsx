...
const Navbar = () => {
    ...
    return (
        <div>
            {/* <!-- navbar start --> */}
            <nav className="sticky top-0 z-10 drop-shadow-[0_.7px_0px_rgba(0,0,0,0.1)]">
                <div className="justify-center items-center">
                    <div className="navbar bg-base-100">
                        ...
                        <div className="navbar-end gap-1 md:gap-2">
                            ...
                            <a href='#' className="bg-green rounded-full"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 32 32" fill="none">
